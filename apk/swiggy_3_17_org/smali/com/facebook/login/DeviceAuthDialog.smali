...
.field private volatile f:Lcom/facebook/h;

.field private volatile g:Ljava/util/concurrent/ScheduledFuture;

.field private volatile h:Lcom/facebook/login/DeviceAuthDialog$a;
...
.field private l:Lcom/facebook/login/i$c;
...
.method public constructor <init>()V
    ...
    .line 96
    iput-object v0, p0, Lcom/facebook/login/DeviceAuthDialog;->l:Lcom/facebook/login/i$c;
...
.method private a(Lcom/facebook/login/DeviceAuthDialog$a;)V
    ...
    .line 219
    iput-object p1, p0, Lcom/facebook/login/DeviceAuthDialog;->h:Lcom/facebook/login/DeviceAuthDialog$a;

    .line 220
    iget-object v0, p0, Lcom/facebook/login/DeviceAuthDialog;->b:Landroid/widget/TextView;

    invoke-virtual {p1}, Lcom/facebook/login/DeviceAuthDialog$a;->b()Ljava/lang/String;
    ...
    .line 222
    invoke-virtual {p1}, Lcom/facebook/login/DeviceAuthDialog$a;->a()Ljava/lang/String;
    ...
    .line 231
    invoke-virtual {v0, v1}, Lcom/facebook/a/l;->a(Ljava/lang/String;)V

    .line 236
    :cond_0
    invoke-virtual {p1}, Lcom/facebook/login/DeviceAuthDialog$a;->e()Z
...
.method static synthetic a(Lcom/facebook/login/DeviceAuthDialog;Ljava/lang/String;Lcom/facebook/internal/y$c;Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
    .locals 0

    .line 72
    invoke-direct/range {p0 .. p6}, Lcom/facebook/login/DeviceAuthDialog;->a(Ljava/lang/String;Lcom/facebook/internal/y$c;Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V

    return-void
.end method

.method static synthetic a(Lcom/facebook/login/DeviceAuthDialog;Ljava/lang/String;Lcom/facebook/internal/y$c;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
    .locals 0

    .line 72
    invoke-direct/range {p0 .. p5}, Lcom/facebook/login/DeviceAuthDialog;->a(Ljava/lang/String;Lcom/facebook/internal/y$c;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
...
.method private a(Ljava/lang/String;Lcom/facebook/internal/y$c;Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
    .locals 12
    ...
    invoke-direct/range {v5 .. v11}, Lcom/facebook/login/DeviceAuthDialog$6;-><init>(Lcom/facebook/login/DeviceAuthDialog;Ljava/lang/String;Lcom/facebook/internal/y$c;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
...
.method private a(Ljava/lang/String;Lcom/facebook/internal/y$c;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
    .locals 12

    move-object v0, p0

    .line 476
    iget-object v1, v0, Lcom/facebook/login/DeviceAuthDialog;->d:Lcom/facebook/login/c;
    ...
    .line 480
    invoke-virtual {p2}, Lcom/facebook/internal/y$c;->a()Ljava/util/List;

    move-result-object v5

    .line 481
    invoke-virtual {p2}, Lcom/facebook/internal/y$c;->b()Ljava/util/List;

    move-result-object v6

    .line 482
    invoke-virtual {p2}, Lcom/facebook/internal/y$c;->c()Ljava/util/List;
    ...
    .line 476
    invoke-virtual/range {v1 .. v11}, Lcom/facebook/login/c;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Collection;Lcom/facebook/d;Ljava/util/Date;Ljava/util/Date;Ljava/util/Date;)V
...
.method private a(Ljava/lang/String;Ljava/lang/Long;Ljava/lang/Long;)V
    ...
    .line 468
    invoke-virtual {v6}, Lcom/facebook/g;->j()Lcom/facebook/h;
...
.method private b()V
    ...
    .line 273
    iget-object v0, p0, Lcom/facebook/login/DeviceAuthDialog;->h:Lcom/facebook/login/DeviceAuthDialog$a;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/facebook/login/DeviceAuthDialog$a;->b(J)V

    .line 274
    invoke-direct {p0}, Lcom/facebook/login/DeviceAuthDialog;->d()Lcom/facebook/g;

    move-result-object v0

    invoke-virtual {v0}, Lcom/facebook/g;->j()Lcom/facebook/h;

    move-result-object v0

    iput-object v0, p0, Lcom/facebook/login/DeviceAuthDialog;->f:Lcom/facebook/h;
...
.method private c()V
    ...
    .line 278
    invoke-static {}, Lcom/facebook/login/c;->d()Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    iget-object v2, p0, Lcom/facebook/login/DeviceAuthDialog;->h:Lcom/facebook/login/DeviceAuthDialog$a;

    .line 285
    invoke-virtual {v2}, Lcom/facebook/login/DeviceAuthDialog$a;->d()J
...
.method private d()Lcom/facebook/g;
    .locals 7
    ...
    invoke-virtual {v0}, Lcom/facebook/login/DeviceAuthDialog$a;->c()Ljava/lang/String;
...
.method static synthetic e(Lcom/facebook/login/DeviceAuthDialog;)Lcom/facebook/login/DeviceAuthDialog$a;
    .locals 0

    .line 72
    iget-object p0, p0, Lcom/facebook/login/DeviceAuthDialog;->h:Lcom/facebook/login/DeviceAuthDialog$a;

    return-object p0
.end method

.method static synthetic f(Lcom/facebook/login/DeviceAuthDialog;)Lcom/facebook/login/i$c;
    .locals 0

    .line 72
    iget-object p0, p0, Lcom/facebook/login/DeviceAuthDialog;->l:Lcom/facebook/login/i$c;
...
.method protected a()V
    ...
    invoke-virtual {v0}, Lcom/facebook/login/DeviceAuthDialog$a;->b()Ljava/lang/String;
    ...
    .line 512
    :cond_1
    iget-object v0, p0, Lcom/facebook/login/DeviceAuthDialog;->d:Lcom/facebook/login/c;

    if-eqz v0, :cond_2

    .line 514
    invoke-virtual {v0}, Lcom/facebook/login/c;->c()V
...
.method protected a(Lcom/facebook/FacebookException;)V
    ...
    invoke-virtual {v0, p1}, Lcom/facebook/login/c;->a(Ljava/lang/Exception;)V
...
.method public a(Lcom/facebook/login/i$c;)V
    .locals 6

    .line 166
    iput-object p1, p0, Lcom/facebook/login/DeviceAuthDialog;->l:Lcom/facebook/login/i$c;
    ...
    .line 170
    invoke-virtual {p1}, Lcom/facebook/login/i$c;->g()Ljava/lang/String;
    ...
    .line 175
    :cond_0
    invoke-virtual {p1}, Lcom/facebook/login/i$c;->h()Ljava/lang/String;
    ...
    .line 215
    invoke-virtual {p1}, Lcom/facebook/g;->j()Lcom/facebook/h;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 108
    invoke-virtual {p2}, Lcom/facebook/login/LoginFragment;->c()Lcom/facebook/login/i;

    move-result-object p2

    .line 109
    invoke-virtual {p2}, Lcom/facebook/login/i;->g()Lcom/facebook/login/l;

    move-result-object p2

    check-cast p2, Lcom/facebook/login/c;

    iput-object p2, p0, Lcom/facebook/login/DeviceAuthDialog;->d:Lcom/facebook/login/c;
...
.method public onDestroy()V
    ...
    .line 156
    iget-object v1, p0, Lcom/facebook/login/DeviceAuthDialog;->f:Lcom/facebook/h;
