...
.method public constructor <init>(Lcom/android/volley/a/b;Lcom/android/volley/a/d;)V
    .locals 0
...
.method public constructor <init>(Lcom/android/volley/a/i;Lcom/android/volley/a/d;)V
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method private a(Lcom/android/volley/a$a;)Ljava/util/Map;
    ...
    .line 268
    invoke-static {v1, v2}, Lcom/android/volley/a/g;->a(J)Ljava/lang/String;
...
.method private a(JLcom/android/volley/i;[BI)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    .line 229
    invoke-virtual {p3}, Lcom/android/volley/i;->getRetryPolicy()Lcom/android/volley/m;

    move-result-object p2

    invoke-interface {p2}, Lcom/android/volley/m;->b()I
...
.method private static a(Ljava/lang/String;Lcom/android/volley/i;Lcom/android/volley/VolleyError;)V
    ...
    .line 241
    invoke-virtual {p1}, Lcom/android/volley/i;->getRetryPolicy()Lcom/android/volley/m;
    ...
    invoke-virtual {p1, p0}, Lcom/android/volley/i;->addMarker(Ljava/lang/String;)V
...
.method private a(Ljava/io/InputStream;I)[B
    ...
    invoke-direct {v0, v1, p2}, Lcom/android/volley/a/m;-><init>(Lcom/android/volley/a/d;I)V
    ...
    .line 291
    invoke-virtual {v0, v2, v1, v3}, Lcom/android/volley/a/m;->write([BII)V

    goto :goto_0

    .line 293
    :cond_0
    invoke-virtual {v0}, Lcom/android/volley/a/m;->toByteArray()[B
    ...
    .line 306
    invoke-virtual {v0}, Lcom/android/volley/a/m;->close()V
...
.method public a(Lcom/android/volley/i;)Lcom/android/volley/h;
    ...
    .line 122
    :try_start_0
    invoke-virtual/range {p1 .. p1}, Lcom/android/volley/i;->getCacheEntry()Lcom/android/volley/a$a;

    move-result-object v0

    invoke-direct {v7, v0}, Lcom/android/volley/a/c;->a(Lcom/android/volley/a$a;)Ljava/util/Map;

    move-result-object v0

    .line 123
    iget-object v3, v7, Lcom/android/volley/a/c;->d:Lcom/android/volley/a/b;

    invoke-virtual {v3, v8, v0}, Lcom/android/volley/a/b;->a(Lcom/android/volley/i;Ljava/util/Map;)Lcom/android/volley/a/h;
    ...
    .line 124
    :try_start_1
    invoke-virtual {v12}, Lcom/android/volley/a/h;->a()I

    move-result v14

    .line 126
    invoke-virtual {v12}, Lcom/android/volley/a/h;->b()Ljava/util/List;
    ...
    invoke-direct/range {v15 .. v21}, Lcom/android/volley/h;-><init>(I[BZJLjava/util/List;)V

    return-object v0

    .line 139
    :cond_0
    invoke-static {v13, v0}, Lcom/android/volley/a/c;->a(Ljava/util/List;Lcom/android/volley/a$a;)Ljava/util/List;
    ...
    invoke-direct/range {v21 .. v27}, Lcom/android/volley/h;-><init>(I[BZJLjava/util/List;)V
    :try_end_2
    ...
    :cond_1
    :try_start_3
    invoke-virtual {v12}, Lcom/android/volley/a/h;->d()Ljava/io/InputStream;
    ...
    .line 152
    :try_start_4
    invoke-virtual {v12}, Lcom/android/volley/a/h;->c()I

    move-result v1

    invoke-direct {v7, v0, v1}, Lcom/android/volley/a/c;->a(Ljava/io/InputStream;I)[B
    ...
    .line 161
    invoke-direct/range {v1 .. v6}, Lcom/android/volley/a/c;->a(JLcom/android/volley/i;[BI)V
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/android/volley/i;->getUrl()Ljava/lang/String;
    ...
    invoke-static {v2, v1}, Lcom/android/volley/n;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v1}, Lcom/android/volley/ClientError;-><init>(Lcom/android/volley/h;)V
    ...
    .line 201
    invoke-virtual/range {p1 .. p1}, Lcom/android/volley/i;->shouldRetryServerErrors()Z
    ...
    invoke-direct {v0, v1}, Lcom/android/volley/ServerError;-><init>(Lcom/android/volley/h;)V

    const-string v1, "server"

    invoke-static {v1, v8, v0}, Lcom/android/volley/a/c;->a(Ljava/lang/String;Lcom/android/volley/i;Lcom/android/volley/VolleyError;)V
    ...
    invoke-direct {v0, v1}, Lcom/android/volley/AuthFailureError;-><init>(Lcom/android/volley/h;)V
