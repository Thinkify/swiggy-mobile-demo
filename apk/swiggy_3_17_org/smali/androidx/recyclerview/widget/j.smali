...
.method private a(Landroidx/recyclerview/widget/RecyclerView$i;Landroidx/recyclerview/widget/m;II)I
    .locals 2

    .line 167
    invoke-virtual {p0, p3, p4}, Landroidx/recyclerview/widget/j;->b(II)[I

    move-result-object p3

    .line 168
    invoke-direct {p0, p1, p2}, Landroidx/recyclerview/widget/j;->b(Landroidx/recyclerview/widget/RecyclerView$i;Landroidx/recyclerview/widget/m;)F
...
.method private b(Landroidx/recyclerview/widget/RecyclerView$i;Landroidx/recyclerview/widget/m;)F
    .locals 10
    ...
    .line 262
    invoke-virtual {p2, v3}, Landroidx/recyclerview/widget/m;->b(Landroid/view/View;)I

    move-result v0

    .line 263
    invoke-virtual {p2, v4}, Landroidx/recyclerview/widget/m;->b(Landroid/view/View;)I
...
.method private d(Landroidx/recyclerview/widget/RecyclerView$i;)Landroidx/recyclerview/widget/m;
    ...
    .line 273
    iget-object v0, p0, Landroidx/recyclerview/widget/j;->b:Landroidx/recyclerview/widget/m;
    ...
    iput-object p1, p0, Landroidx/recyclerview/widget/j;->b:Landroidx/recyclerview/widget/m;

    .line 276
    :cond_1
    iget-object p1, p0, Landroidx/recyclerview/widget/j;->b:Landroidx/recyclerview/widget/m;
...
.method private e(Landroidx/recyclerview/widget/RecyclerView$i;)Landroidx/recyclerview/widget/m;
    ...
    .line 282
    iget-object v0, p0, Landroidx/recyclerview/widget/j;->c:Landroidx/recyclerview/widget/m;
    ...
    iput-object p1, p0, Landroidx/recyclerview/widget/j;->c:Landroidx/recyclerview/widget/m;

    .line 285
    :cond_1
    iget-object p1, p0, Landroidx/recyclerview/widget/j;->c:Landroidx/recyclerview/widget/m;
...
.method public a(Landroidx/recyclerview/widget/RecyclerView$i;II)I
    ...
    .line 75
    :cond_1
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/j;->a(Landroidx/recyclerview/widget/RecyclerView$i;)Landroid/view/View;
    ...
    check-cast v3, Landroidx/recyclerview/widget/RecyclerView$t$b;

    add-int/lit8 v4, v0, -0x1

    .line 90
    invoke-interface {v3, v4}, Landroidx/recyclerview/widget/RecyclerView$t$b;->d(I)Landroid/graphics/PointF;
    ...
    .line 99
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/j;->e(Landroidx/recyclerview/widget/RecyclerView$i;)Landroidx/recyclerview/widget/m;

    move-result-object v5

    .line 98
    invoke-direct {p0, p1, v5, p2, v7}, Landroidx/recyclerview/widget/j;->a(Landroidx/recyclerview/widget/RecyclerView$i;Landroidx/recyclerview/widget/m;II)I
    ...
    .line 108
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/j;->d(Landroidx/recyclerview/widget/RecyclerView$i;)Landroidx/recyclerview/widget/m;

    move-result-object v5

    .line 107
    invoke-direct {p0, p1, v5, v7, p3}, Landroidx/recyclerview/widget/j;->a(Landroidx/recyclerview/widget/RecyclerView$i;Landroidx/recyclerview/widget/m;II)I
...
.method public a(Landroidx/recyclerview/widget/RecyclerView$i;)Landroid/view/View;
    ...
    invoke-direct {p0, p1, v0}, Landroidx/recyclerview/widget/j;->a(Landroidx/recyclerview/widget/RecyclerView$i;Landroidx/recyclerview/widget/m;)Landroid/view/View;
...
.method public a(Landroidx/recyclerview/widget/RecyclerView$i;Landroid/view/View;)[I
    ...
    .line 48
    invoke-direct {p0, p1, p2, v1}, Landroidx/recyclerview/widget/j;->a(Landroidx/recyclerview/widget/RecyclerView$i;Landroid/view/View;Landroidx/recyclerview/widget/m;)I
