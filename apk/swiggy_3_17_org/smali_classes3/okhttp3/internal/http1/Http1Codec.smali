...
.method private readHeaderLine()Ljava/lang/String;
    ...
    invoke-interface {v0, v1, v2}, La/e;->f(J)Ljava/lang/String;
...
.method public createRequestBody(Lokhttp3/Request;J)La/s;
    .locals 2
    ...
    .line 100
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSink()La/s;
    ...
    .line 105
    invoke-virtual {p0, p2, p3}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSink(J)La/s;
...
.method detachTimeout(La/i;)V
    ...
    .line 268
    invoke-virtual {p1}, La/i;->a()La/u;

    move-result-object v0

    .line 269
    sget-object v1, La/u;->NONE:La/u;

    invoke-virtual {p1, v1}, La/i;->a(La/u;)La/i;
...
.method public newChunkedSink()La/s;
    .locals 3
...
.method public newChunkedSource(Lokhttp3/HttpUrl;)La/t;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newFixedLengthSink(J)La/s;
    .locals 2
...
.method public newFixedLengthSource(J)La/t;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newUnknownLengthSource()La/t;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    .line 138
    invoke-virtual {p0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)La/t;
    ...
    invoke-direct {v3, v0, v1, v2, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLa/e;)V
    ...
    invoke-virtual {p0, p1}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSource(Lokhttp3/HttpUrl;)La/t;
    ...
    invoke-direct {v1, v0, v2, v3, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLa/e;)V
    ...
    .line 149
    invoke-virtual {p0, v4, v5}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)La/t;
    ...
    invoke-direct {v1, v0, v4, v5, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLa/e;)V
    ...
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newUnknownLengthSource()La/t;

    move-result-object v1

    invoke-static {v1}, La/l;->a(La/t;)La/e;

    move-result-object v1

    invoke-direct {p1, v0, v2, v3, v1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLa/e;)V
...
.method public writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    .line 179
    :cond_0
    iget-object p1, p0, Lokhttp3/internal/http1/Http1Codec;->sink:La/d;
