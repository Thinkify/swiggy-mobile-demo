...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-static {p1}, La/l;->b(Ljava/net/Socket;)La/t;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:La/e;

    .line 260
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->rawSocket:Ljava/net/Socket;

    invoke-static {p1}, La/l;->a(Ljava/net/Socket;)La/s;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:La/d;
    :try_end_1
...
.method private connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 228
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:La/d;

    .line 229
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:La/e;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;La/e;La/d;)V

    .line 380
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:La/e;

    invoke-interface {v1}, La/e;->timeout()La/u;
    ...
    invoke-virtual {v1, v4, v5, v2}, La/u;->timeout(JLjava/util/concurrent/TimeUnit;)La/u;

    .line 381
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:La/d;

    invoke-interface {v1}, La/d;->timeout()La/u;
    ...
    .line 393
    :cond_0
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)La/t;
    ...
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(La/t;ILjava/util/concurrent/TimeUnit;)Z
    ...
    .line 403
    :cond_4
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:La/e;

    invoke-interface {p1}, La/e;->b()La/c;
    ...
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:La/d;
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 177
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->source:La/e;

    .line 178
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->sink:La/d;
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    invoke-virtual {v0, v1, v2, v3}, La/u;->timeout(JLjava/util/concurrent/TimeUnit;)La/u;

    .line 528
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:La/d;

    invoke-interface {v0}, La/d;->timeout()La/u;
    ...
    invoke-virtual {v0, v1, v2, p2}, La/u;->timeout(JLjava/util/concurrent/TimeUnit;)La/u;
    ...
    invoke-direct {p2, p1, p3, v0, v1}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;La/e;La/d;)V
