...
.method private newJournalWriter()La/d;
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)La/s;
    ...
    invoke-direct {v1, p0, v0}, Lokhttp3/internal/cache/DiskLruCache$2;-><init>(Lokhttp3/internal/cache/DiskLruCache;La/s;)V
...
.method private readJournal()V
    ...
    invoke-interface {v1, v2}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)La/t;
    ...
    .line 278
    :try_start_0
    invoke-interface {v1}, La/e;->r()Ljava/lang/String;
...
.method declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    .line 574
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:La/d;
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(La/d;)V
...
.method declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 486
    :cond_3
    iget-object p2, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:La/d;

    const-string p3, "DIRTY"

    invoke-interface {p2, p3}, La/d;->b(Ljava/lang/String;)La/d;
    ...
    invoke-interface {p2, p1}, La/d;->b(Ljava/lang/String;)La/d;
    ...
    invoke-interface {p2}, La/d;->flush()V
...
.method public declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {p1, v1}, La/d;->i(I)La/d;
...
.method declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)La/s;
    ...
    invoke-interface {v0, v3, v4}, La/d;->m(J)La/d;
    ...
    .line 406
    invoke-interface {v0, v4}, La/d;->b(Ljava/lang/String;)La/d;

    move-result-object v4

    invoke-interface {v4, v5}, La/d;->i(I)La/d;

    .line 407
    iget-object v3, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->key:Ljava/lang/String;

    invoke-interface {v0, v3}, La/d;->b(Ljava/lang/String;)La/d;
    ...
    .line 412
    invoke-virtual {v3, v0}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(La/d;)V
