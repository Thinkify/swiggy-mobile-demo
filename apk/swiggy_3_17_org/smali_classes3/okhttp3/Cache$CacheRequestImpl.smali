...
# instance fields
.field private body:La/s;

.field private cacheOut:La/s;
...
.method constructor <init>(Lokhttp3/Cache;Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 442
    invoke-virtual {p2, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)La/s;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/Cache$CacheRequestImpl;->cacheOut:La/s;

    .line 443
    new-instance v0, Lokhttp3/Cache$CacheRequestImpl$1;

    iget-object v1, p0, Lokhttp3/Cache$CacheRequestImpl;->cacheOut:La/s;

    invoke-direct {v0, p0, v1, p1, p2}, Lokhttp3/Cache$CacheRequestImpl$1;-><init>(Lokhttp3/Cache$CacheRequestImpl;La/s;Lokhttp3/Cache;Lokhttp3/internal/cache/DiskLruCache$Editor;)V

    iput-object v0, p0, Lokhttp3/Cache$CacheRequestImpl;->body:La/s;
...
.method public abort()V
    ...
    .line 466
    iget-object v0, p0, Lokhttp3/Cache$CacheRequestImpl;->cacheOut:La/s;
...
.method public body()La/s;
    .locals 1

    .line 474
    iget-object v0, p0, Lokhttp3/Cache$CacheRequestImpl;->body:La/s;
