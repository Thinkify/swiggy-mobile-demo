...
.method public final animateAdd(Landroidx/recyclerview/widget/RecyclerView$x;)Z
    .locals 2

    .line 8
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/google/android/libraries/places/internal/fn;->endAnimation(Landroidx/recyclerview/widget/RecyclerView$x;)V
    ...
    invoke-static {v0, v1}, Landroidx/core/h/w;->c(Landroid/view/View;F)V
...
.method public final endAnimation(Landroidx/recyclerview/widget/RecyclerView$x;)V
    .locals 2

    .line 21
    :try_start_0
    invoke-super {p0, p1}, Landroidx/recyclerview/widget/d;->endAnimation(Landroidx/recyclerview/widget/RecyclerView$x;)V
    ...
    .line 25
    invoke-virtual {p0, p1}, Lcom/google/android/libraries/places/internal/fn;->dispatchAddFinished(Landroidx/recyclerview/widget/RecyclerView$x;)V
...
.method public final endAnimations()V
    ...
    .line 42
    invoke-virtual {p0, v1}, Lcom/google/android/libraries/places/internal/fn;->dispatchAddFinished(Landroidx/recyclerview/widget/RecyclerView$x;)V
    ...
    .line 49
    :cond_1
    invoke-super {p0}, Landroidx/recyclerview/widget/d;->endAnimations()V
    :try_end_0
    .catch Ljava/lang/Error; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final isRunning()Z
    ...
    .line 31
    :try_start_0
    invoke-super {p0}, Landroidx/recyclerview/widget/d;->isRunning()Z
...
.method public final runPendingAnimations()V
    ...
    .line 55
    invoke-super {p0, v4}, Landroidx/recyclerview/widget/d;->animateAdd(Landroidx/recyclerview/widget/RecyclerView$x;)Z
    ...
    .line 58
    invoke-super {p0}, Landroidx/recyclerview/widget/d;->runPendingAnimations()V
    ...
    new-instance v9, Landroidx/f/a/a/b;

    invoke-direct {v9}, Landroidx/f/a/a/b;-><init>()V
    ...
    invoke-direct {v5, p0, v4, v3, v8}, Lcom/google/android/libraries/places/internal/fo;-><init>(Lcom/google/android/libraries/places/internal/fn;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView$x;Landroid/view/ViewPropertyAnimator;)V
