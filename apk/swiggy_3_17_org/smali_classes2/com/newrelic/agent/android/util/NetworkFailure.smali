...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v1, v3}, Lcom/newrelic/agent/android/util/NetworkFailure;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v0, v3, v2, v4}, Lcom/newrelic/agent/android/util/NetworkFailure;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v0, v4, v3, v5}, Lcom/newrelic/agent/android/util/NetworkFailure;-><init>(Ljava/lang/String;II)V
    ...
    const-string v5, "CannotConnectToHost"

    const/16 v6, -0x3ec

    invoke-direct {v0, v5, v4, v6}, Lcom/newrelic/agent/android/util/NetworkFailure;-><init>(Ljava/lang/String;II)V
    ...
    const-string v6, "DNSLookupFailed"

    const/16 v7, -0x3ee

    invoke-direct {v0, v6, v5, v7}, Lcom/newrelic/agent/android/util/NetworkFailure;-><init>(Ljava/lang/String;II)V
    ...
    const-string v7, "BadServerResponse"

    const/16 v8, -0x3f3

    invoke-direct {v0, v7, v6, v8}, Lcom/newrelic/agent/android/util/NetworkFailure;-><init>(Ljava/lang/String;II)V
    ...
    const-string v8, "SecureConnectionFailed"

    const/16 v9, -0x4b0

    invoke-direct {v0, v8, v7, v9}, Lcom/newrelic/agent/android/util/NetworkFailure;-><init>(Ljava/lang/String;II)V
    ...
    .line 17
    sget-object v8, Lcom/newrelic/agent/android/util/NetworkFailure;->Unknown:Lcom/newrelic/agent/android/util/NetworkFailure;
