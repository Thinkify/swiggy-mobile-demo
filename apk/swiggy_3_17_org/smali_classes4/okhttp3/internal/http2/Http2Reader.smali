...
.method constructor <init>(La/e;Z)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/e;

    invoke-direct {p1, p2}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(La/e;)V
    ...
    invoke-direct {p1, v0, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILa/t;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 214
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/e;

    invoke-interface {p1, v1, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILa/e;I)V

    .line 215
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/e;
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 319
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/e;

    invoke-interface {p4}, La/e;->k()I
    ...
    invoke-interface {p3, v1, v2}, La/e;->d(J)La/f;

    move-result-object p3

    .line 330
    :cond_0
    invoke-interface {p1, p4, v0, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;La/f;)V
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {p1, v0, v1}, La/e;->i(J)V
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:La/f;
    ...
    invoke-interface {p1, v3, v4}, La/e;->d(J)La/f;
